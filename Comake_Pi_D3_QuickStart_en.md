...
![Main board interfaces](mymedia/Comake_Pi_D3_QuickStart/board-main.svg)

![Baseboard interfaces](mymedia/Comake_Pi_D3_QuickStart/board-base.svg)
...
![Firmware Upgrade](mymedia/Comake_Pi_D3_QuickStart/full_en.png)

### 6.4 Single-Partition Upgrade

1. Open "UsbDevelopToolUI.exe" --> "Advanced" and unpack the original firmware.

    ![](mymedia/Comake_Pi_D3_QuickStart/advanced_en.png)
...
3. Switch to the tool's "Single Partition" interface, select the device, browse to package.ini under the unpacked directory, check the partitions you want to upgrade, and then click "Start Upgrade".
    ...
    ![](mymedia/Comake_Pi_D3_QuickStart/single_en.png)
...
![Download archive](mymedia/Comake_Pi_D3_QuickStart/gitweb-download_en.png)
...
3. Click "New Issue"
    ...
    ![Create an issue](mymedia/Comake_Pi_D3_QuickStart/gitweb-issue-1_en.png)
...
5. Click the "Create Issue" confirmation button
    ...
    ![Create an issue](mymedia/Comake_Pi_D3_QuickStart/gitweb-issue-2_en.png)
